	...
	if ($product->get_type() == 'crowdfunding') {
		if ( wpcf_function()->is_campaign_valid( $post->ID ) ) {
            ...
            <form enctype="multipart/form-data" method="post" class="cart AA">
                ...
                <button type="submit" class="<?php echo apply_filters('add_to_donate_button_class', 'btn-back-campaign btn-theme-2 wpneo_donate_button'); ?>"><span><?php _e('Back Project', 'krowd'); ?></span></button>
            </form>
         <?php }else{ ?>
         	<a href="<?php echo esc_url($extra_link) ?>" class="btn-back-campaign btn-theme-2"><span><?php echo esc_html__('Back Project', 'krowd'); ?></span></a>
         <?php } ?>
